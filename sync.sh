...
ssh -i ~/.ssh/mac_id_rsa ar4jf2nz@jhwebex.com "find /home/ar4jf2nz/public_html/QA -type f | grep -v '\/old\/' | while read f;do cksum \$f | awk '{print \$NF, \$1}' | sed 's#/home/ar4jf2nz/public_html/qa##';done" | sort > remote.cksum
