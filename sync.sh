...
ssh -i ${SECRETKEY} ${SECRETUSER}@${SECRETHOST} "find /home/ar4jf2nz/public_html/QA_${BASE_DIRNAME} -type f | grep -v '\/old\/' | while read f;do cksum \$f | awk '{print \$NF, \$1}' | sed 's#/home/ar4jf2nz/public_html/QA_${BASE_DIRNAME}/##';done" | sort > remote.cksum
